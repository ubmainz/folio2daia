...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" version="2.0">
    ...
    <xsl:variable name="bbtabelle">
        ...
        <e>
            ...
            <map url="https://ub-mainz.mapongo.de/viewer?p=1&amp;b=5&amp;f=14&amp;c=23728&amp;l=9736"/><nostandort/>
            <url>https://www.ub.uni-mainz.de/de/standorte#zentralbibliothek</url>
        </e>
        <e>
        ...
        <e>
            ...
            <map url="https://ub-mainz.mapongo.de/?p=1&amp;b=2&amp;f=3&amp;c=23811&amp;l=23808,23809"/><nostandort/>
            <url>https://www.ub.uni-mainz.de/de/standorte#philosophicum</url>
        </e>
        <e>
        ...
        <e>
            ...
            <url>https://www.ub.uni-mainz.de/de/standorte#mathematik-informatik-naturwissenschaften-und-technik</url><nostandort/>
        </e>
        <e>
        ...
        <e>
            ...
            <map url="https://ub-mainz.mapongo.de/viewer?p=1&amp;b=1&amp;f=1&amp;l=1170&amp;lang=de"/><nostandort/>
            <url>https://www.ub.uni-mainz.de/de/standorte#theologie</url>
        </e>
        <e>
        ...
        <e>
            <c>25/018-018-11-RWR</c><ind>s Praesenzbestand</ind><campus>cm</campus><n xml:lang="de">BB Rechts- und Wirtschaftswissenschaften, Rechtswissenschaft</n><map linktype="mapongo"/>
            <url>https://www.ub.uni-mainz.de/de/standorte#rechts-und-wirtschaftswissenschaften</url>
        </e>
        <e>
            <c>25/018-018-12-RWW</c><ind>s Praesenzbestand</ind><campus>cm</campus><n xml:lang="de">BB Rechts- und Wirtschaftswissenschaften, Wirtschaftswissenschaften</n><map linktype="mapongo"/>
            <url>https://www.ub.uni-mainz.de/de/standorte#rechts-und-wirtschaftswissenschaften</url>
        </e>
        <e>
            <c>25/018-018-13-RWM</c><ind>s Praesenzbestand</ind><campus>cm</campus><n xml:lang="de">BB Rechts- und Wirtschaftswissenschaften, Medizin</n><map linktype="mapongo"/>
            <url>https://www.ub.uni-mainz.de/de/standorte#rechts-und-wirtschaftswissenschaften</url>
        </e>
        <e>
        ...
        <e>
            ...
            <url>https://www.ub.uni-mainz.de/de/standorte#rechts-und-wirtschaftswissenschaften</url><nostandort/>
        </e>
        <e>
        ...
        <e>
            ...
            <map url="https://ub-mainz.mapongo.de/viewer?p=1&amp;b=7&amp;f=20&amp;c=23620&amp;l=19809,19815,19816"/><nostandort/>
            <url>https://www.ub.uni-mainz.de/de/standorte#translations-sprach-und-kulturwissenschaft</url>
        </e>
        <e>
        ...
        <e>
            ...
            <map url="https://ub-mainz.mapongo.de/viewer?p=1&amp;b=2&amp;f=4&amp;c=23932&amp;l=7919&amp;lang=de"/><nostandort/>
            <url>https://www.ub.uni-mainz.de/de/standorte#philosophicum-standort-musikwissenschaft</url>
        </e>        
        <e>
        ...
        <e>
            <c>25/112-112-13-PHHFM-SEMAPPALLG</c><ind>s Praesenzbestand</ind><n xml:lang="de">BB Philosophicum, Hochschule für Musik, Semesterapparate</n>
    ...
    <xsl:template match="status[name(..)='item']"> <!-- Trigger für Status (als immer eindeutig vorhanden vorausgesetzt) für Status und Ausleihindikator - emuliert LBS -->
        ...
        <xsl:variable name="result">
            <xsl:variable name="emulator">
                ...
                <status name='Available'>              <b>UF</b><c>UF</c><d>UF</d><e>EM</e><i>IF</i><n>SX</n><p>ZF</p><s>SX</s><u>UF</u> </status> <!-- b,c,d ist in Mainz ausleihbar -->
                ...
                <status name='Checked out'>            <b>UV</b><c>UV</c><d>UV</d><e>EM</e><i>IV</i><n>CN</n><p>UV</p><s>CN</s><u>UV</u> </status>
                ...
                <status name='In process - not requestable'/> <!-- "In process (not-requestable)" ab Ramsons -->
            ...
            <xsl:variable name="campusubmainz">
                ...
                <hinweis-u campus="cz">
                    ...
                    <t2 xml:lang="en">Germersheim: order</t2>
                    <t3 xml:lang="de">Universitätsmedizin: bestellen</t3>
                    <t3 xml:lang="en">Universitätsmedizin: order</t3>
                    <t4 xml:lang="de">&lt;b&gt;&lt;font color="red"&gt;Alle anderen: selbst am Regal holen&lt;/font&gt;&lt;/b&gt;</t4>
                    <t4 xml:lang="en">&lt;b&gt;&lt;font color="red"&gt;Everyone else: pick up on the shelf&lt;/font&gt;&lt;/b&gt;</t4>
                </hinweis-u>
                <hinweis-s campus="cg">
                    <t2 xml:lang="de">Aufsatzkopien/Kurzausleihe für Campus Mainz möglich, bitte wenden Sie sich an die Information</t2>
            ...
            <xsl:variable name="cases">
                ...
                <UV><i>u ausleihbar</i><s>vormerkbar</s><h>https://paia.link</h>
                    <d><xsl:value-of select="xs:dateTime((current()/../status/date,current-dateTime())[1])+xs:dayTimeDuration('P28D')"/></d></UV> <!-- vormerkbar -->
                <IV><i>i Lesesaal</i><s>vormerkbar</s><h>https://paia.link</h>
                    <d><xsl:value-of select="xs:dateTime((current()/../status/date,current-dateTime())[1])+xs:dayTimeDuration('P28D')"/></d>
                    <t1 xml:lang="de">nur für den Lesesaal</t1><t1 xml:lang="en">reading room only</t1></IV> <!-- nur für den Lesesaal vormerkbar -->
                ...
                <YO><i>a bestellt</i><s>gesperrt</s></YO><!-- Bestellt, aber nicht bestellbar -->
