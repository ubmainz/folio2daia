...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:variable name="bbtabelle">
        ...
        <e>
            ...
            <n xml:lang="de">Bibliothek Tierklinik f&#xfc;r Reproduktionsmedizin und
                Neugeborenenkunde</n>
            <url>https://www.uni-giessen.de/ub/de/ueber-uns/standorte/ub-db/1</url>
            <campus>Fachbibliotheken</campus>
        </e>
    ...
    <xsl:variable name="hap-tabelle">
        ...
        <hap nr="hap10510272">Prof. Jacob, Inst. f. Germanistik, Arbeitsber. Literatur, Phil I
            B",</hap>
    ...
    <xsl:template name="mapongo">
        ...
        <xsl:variable name="mapongopar">
            ...
            <xsl:if
                test="../../notes[holdingsNoteTypeId = '013e0b2c-2259-4ee8-8d15-f463f1aeb0b1']/note">
                <xsl:text>&amp;c1=</xsl:text>
                <!-- c1: "8201" -->
                <xsl:value-of
                    select="encode-for-uri(../../notes[holdingsNoteTypeId = '013e0b2c-2259-4ee8-8d15-f463f1aeb0b1']/note)"
                />
            </xsl:if>
